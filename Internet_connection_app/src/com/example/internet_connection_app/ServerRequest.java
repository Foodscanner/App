...
public class ServerRequest {
	...
	public ServerRequest(String barCode, MainActivity ac) {
      ...
      ConnectivityManager connMgr = (ConnectivityManager) 
          this.ac.getSystemService(Context.CONNECTIVITY_SERVICE);
      NetworkInfo networkInfo = connMgr.getActiveNetworkInfo();
      if (networkInfo != null && networkInfo.isConnected()) {
          new DataBaseRequest().execute(serverURL);
      } else {
         Toast.makeText(this.ac, "No network connection available.", Toast.LENGTH_SHORT).show();
      }
  }
   ...
   *
   */
  private class DataBaseRequest extends AsyncTask<String, Void, Article>{
	...
	protected Article doInBackground(String... urls) {
     ...
     protected void onPostExecute(Article result) {
		 ac.display.setText(result._description);
		 
		 //
		 //fill activity
//		 ServerRequest.this.respond =result;
...
//a string.
private Article downloadArtInfo(String myurl) throws IOException {
